...
Допустимые фазы, полный словарь тегов, производные теги и правила редактирования перечислены в [`docs/RELOCATION_WIZARD.md`](docs/RELOCATION_WIZARD.md). Не добавляйте произвольный новый тег только в статью: неизвестный тег должен останавливать линтер и Astro schema validation.
